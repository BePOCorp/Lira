            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12" >
                        ...
                        <?php endif;?>
                        <form action="<?php echo base_url(); ?>mantenimiento/actividades/update" method="POST">
                            <!--
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo $unaactividad->descripcion?>" >
                            </div>
                            <!--
                            <div class="form-group col-md-6">
