        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url(); ?>mantenimiento/docentes"><i class="fa fa-circle-o"></i> Docentes</a></li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url(); ?>mantenimiento/plantrabajo"><i class="fa fa-circle-o"></i> Plan de Trabajo</a></li>
                    <li><a href="<?php echo base_url(); ?>mantenimiento/seguimiento"><i class="fa fa-circle-o"></i> Seguimiento</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
