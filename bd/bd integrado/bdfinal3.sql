...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2019 a las 07:12:30
...
--
-- Estructura de tabla para la tabla `asignacion_titulacion`
--

CREATE TABLE `asignacion_titulacion` (
  `id` int(11) NOT NULL,
  `id_egresado` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `carga_no_lectiva`
--
...
--
-- Estructura de tabla para la tabla `carga_no_lectiva_detalle`
--

CREATE TABLE `carga_no_lectiva_detalle` (
  `id` int(11) NOT NULL,
  `descripcion` varchar(50) NOT NULL,
...
CREATE TABLE `curso` (
  ...
  `id_ciclo` int(11) NOT NULL,
  `id_plan_curricular` int(11) NOT NULL,
  `horas` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `curso_pre_requisitos`
--

CREATE TABLE `curso_pre_requisitos` (
  `id_curso` int(11) NOT NULL,
  `id_curso_requisito` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `experiencia_docencia` (
  ...
  `tipo_instituto` varchar(30) NOT NULL,
...
--
-- Estructura de tabla para la tabla `numero_semana`
--

CREATE TABLE `numero_semana` (
  `id` int(11) NOT NULL,
  `descripcion` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `persona` (
  ...
  `verificacion_cv` varchar(50) NOT NULL,
  `id_escuela` int(11) NOT NULL,
...
CREATE TABLE `plan_trabajo` (
  `id` int(11) NOT NULL,
  `descripcion` varchar(50) NOT NULL,
  `id_carga_no_lectiva` int(11) NOT NULL,
  `id_numero_semana` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `anuncio_persona`
  ADD PRIMARY KEY (`id_persona`,`id_anuncio`),
...
--
-- Indices de la tabla `asignacion_titulacion`
--
ALTER TABLE `asignacion_titulacion`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_egresado` (`id_egresado`),
...
ALTER TABLE `bibliotecario`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_postulante` (`id_persona`),
  ADD KEY `id_biblioteca` (`id_biblioteca`);
...
--
-- Indices de la tabla `carga_no_lectiva`
--
...
--
-- Indices de la tabla `carga_no_lectiva_detalle`
--
ALTER TABLE `carga_no_lectiva_detalle`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `curso`
  ...
  ADD KEY `id_ciclo` (`id_ciclo`),
  ADD KEY `id_plan_curricular` (`id_plan_curricular`);
...
--
-- Indices de la tabla `curso_pre_requisitos`
--
ALTER TABLE `curso_pre_requisitos`
  ADD PRIMARY KEY (`id_curso`,`id_curso_requisito`),
  ADD KEY `id_curso_requisito` (`id_curso_requisito`);
...
ALTER TABLE `horario_alumno`
  ADD PRIMARY KEY (`id_horario_curso`,`id_matricula`),
  ADD KEY `id_matricula` (`id_matricula`);
...
--
-- Indices de la tabla `numero_semana`
--
ALTER TABLE `numero_semana`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `plan_trabajo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_carga_no_lectiva` (`id_carga_no_lectiva`),
  ADD KEY `id_numero_semana` (`id_numero_semana`);
...
--
-- AUTO_INCREMENT de la tabla `asignacion_titulacion`
--
ALTER TABLE `asignacion_titulacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `carga_no_lectiva`
--
ALTER TABLE `carga_no_lectiva`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `carga_no_lectiva_detalle`
--
ALTER TABLE `carga_no_lectiva_detalle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `numero_semana`
--
ALTER TABLE `numero_semana`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `administrativo`
  ...
  ADD CONSTRAINT `administrativo_ibfk_3` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`);

--
-- Filtros para la tabla `alumno`
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `alumno_ibfk_10` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id`),
  ADD CONSTRAINT `alumno_ibfk_11` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
  ...
  ADD CONSTRAINT `alumno_ibfk_9` FOREIGN KEY (`id_especialidad`) REFERENCES `especialidad` (`id`);
...
--
ALTER TABLE `anuncio_persona`
  ADD CONSTRAINT `anuncio_persona_ibfk_1` FOREIGN KEY (`id_anuncio`) REFERENCES `anuncio` (`id`),
  ADD CONSTRAINT `anuncio_persona_ibfk_2` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`);

--
-- Filtros para la tabla `archivos`
--
ALTER TABLE `archivos`
  ADD CONSTRAINT `archivos_ibfk_1` FOREIGN KEY (`id_egresado`) REFERENCES `egresado` (`id`),
  ADD CONSTRAINT `archivos_ibfk_2` FOREIGN KEY (`id_tipo_archivo`) REFERENCES `tipo_archivo` (`id`);

--
-- Filtros para la tabla `asesor`
--
ALTER TABLE `asesor`
  ADD CONSTRAINT `asesor_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
  ADD CONSTRAINT `asesor_ibfk_2` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id`);
...
--
-- Filtros para la tabla `asignacion_titulacion`
--
ALTER TABLE `asignacion_titulacion`
  ADD CONSTRAINT `asignacion_titulacion_ibfk_1` FOREIGN KEY (`id_egresado`) REFERENCES `egresado` (`id`),
  ADD CONSTRAINT `asignacion_titulacion_ibfk_2` FOREIGN KEY (`id_administrativo`) REFERENCES `administrativo` (`id`),
  ADD CONSTRAINT `asignacion_titulacion_ibfk_3` FOREIGN KEY (`id_asesor`) REFERENCES `asesor` (`id`),
  ADD CONSTRAINT `asignacion_titulacion_ibfk_4` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id`);
...
--
ALTER TABLE `bibliotecario`
  ADD CONSTRAINT `bibliotecario_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
...
--
-- Filtros para la tabla `carga_no_lectiva`
--
ALTER TABLE `carga_no_lectiva`
  ADD CONSTRAINT `carga_no_lectiva_ibfk_1` FOREIGN KEY (`id_actividad`) REFERENCES `actividad` (`id`),
  ADD CONSTRAINT `carga_no_lectiva_ibfk_2` FOREIGN KEY (`id_docente`) REFERENCES `docente` (`id`);

--
-- Filtros para la tabla `carga_no_lectiva_detalle`
--
ALTER TABLE `carga_no_lectiva_detalle`
  ADD CONSTRAINT `carga_no_lectiva_detalle_ibfk_1` FOREIGN KEY (`id_plan_trabajo`) REFERENCES `plan_trabajo` (`id`);
...
--
ALTER TABLE `confirmacion`
  ADD CONSTRAINT `confirmacion_ibfk_1` FOREIGN KEY (`id_egresado`) REFERENCES `egresado` (`id`),
  ADD CONSTRAINT `confirmacion_ibfk_2` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id`);

--
-- Filtros para la tabla `contrato`
--
ALTER TABLE `contrato`
  ADD CONSTRAINT `contrato_ibfk_1` FOREIGN KEY (`id_postulante`) REFERENCES `postulante` (`id`);

--
-- Filtros para la tabla `cumplimiento`
--
ALTER TABLE `cumplimiento`
  ADD CONSTRAINT `cumplimiento_ibfk_1` FOREIGN KEY (`id_plan_trabajo`) REFERENCES `plan_trabajo` (`id`);
...
ALTER TABLE `curso`
  ...
  ADD CONSTRAINT `curso_ibfk_3` FOREIGN KEY (`id_plan_curricular`) REFERENCES `plan_curricular` (`id`),
  ADD CONSTRAINT `curso_ibfk_4` FOREIGN KEY (`id_ciclo`) REFERENCES `ciclo` (`id`);

--
-- Filtros para la tabla `cursos_llevados`
--
ALTER TABLE `cursos_llevados`
  ADD CONSTRAINT `cursos_llevados_ibfk_1` FOREIGN KEY (`id_alumno`) REFERENCES `alumno` (`id`),
  ADD CONSTRAINT `cursos_llevados_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id`);
...
--
-- Filtros para la tabla `curso_pre_requisitos`
--
ALTER TABLE `curso_pre_requisitos`
  ADD CONSTRAINT `curso_pre_requisitos_ibfk_1` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id`),
  ADD CONSTRAINT `curso_pre_requisitos_ibfk_2` FOREIGN KEY (`id_curso_requisito`) REFERENCES `curso` (`id`);
...
ALTER TABLE `docente`
  ...
  ADD CONSTRAINT `docente_ibfk_4` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`);

--
-- Filtros para la tabla `documento`
--
ALTER TABLE `documento`
  ADD CONSTRAINT `documento_ibfk_1` FOREIGN KEY (`id_tipo_documento`) REFERENCES `tipo_documento` (`id`);
...
ALTER TABLE `egresado`
  ...
  ADD CONSTRAINT `egresado_ibfk_2` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`);
...
ALTER TABLE `eva_ccd_postulante`
  ...
  ADD CONSTRAINT `eva_ccd_postulante_ibfk_3` FOREIGN KEY (`id_administrativo`) REFERENCES `administrativo` (`id`);
...
--
ALTER TABLE `horario_alumno`
  ADD CONSTRAINT `horario_alumno_ibfk_1` FOREIGN KEY (`id_horario_curso`) REFERENCES `horario_curso` (`id`),
  ADD CONSTRAINT `horario_alumno_ibfk_2` FOREIGN KEY (`id_matricula`) REFERENCES `matricula` (`id`);

--
-- Filtros para la tabla `horario_curso`
--
ALTER TABLE `horario_curso`
  ADD CONSTRAINT `horario_curso_ibfk_1` FOREIGN KEY (`id_docente`) REFERENCES `docente` (`id`),
  ADD CONSTRAINT `horario_curso_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `curso` (`id`),
  ADD CONSTRAINT `horario_curso_ibfk_3` FOREIGN KEY (`id_aula`) REFERENCES `aula` (`id`),
  ADD CONSTRAINT `horario_curso_ibfk_4` FOREIGN KEY (`id_dia`) REFERENCES `dia` (`id`);
...
ALTER TABLE `matricula`
  ...
  ADD CONSTRAINT `matricula_ibfk_4` FOREIGN KEY (`id_pago`) REFERENCES `pago` (`id`),
  ADD CONSTRAINT `matricula_ibfk_5` FOREIGN KEY (`id_plan_curricular`) REFERENCES `plan_curricular` (`id`);
...
--
ALTER TABLE `perfil_profesional`
  ADD CONSTRAINT `perfil_profesional_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`);

--
-- Filtros para la tabla `permiso`
--
ALTER TABLE `permiso`
  ADD CONSTRAINT `permiso_ibfk_1` FOREIGN KEY (`id_menu`) REFERENCES `menu` (`id`);

--
-- Filtros para la tabla `plan_curricular`
--
ALTER TABLE `plan_curricular`
  ADD CONSTRAINT `plan_curricular_ibfk_1` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id`);

--
-- Filtros para la tabla `plan_trabajo`
--
ALTER TABLE `plan_trabajo`
  ADD CONSTRAINT `plan_trabajo_ibfk_1` FOREIGN KEY (`id_carga_no_lectiva`) REFERENCES `carga_no_lectiva` (`id`),
  ADD CONSTRAINT `plan_trabajo_ibfk_2` FOREIGN KEY (`id_numero_semana`) REFERENCES `numero_semana` (`id`);
...
ALTER TABLE `postulante`
  ...
  ADD CONSTRAINT `postulante_ibfk_12` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
...
--
ALTER TABLE `seguimiento`
  ADD CONSTRAINT `seguimiento_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id`),
  ADD CONSTRAINT `seguimiento_ibfk_2` FOREIGN KEY (`id_egresado`) REFERENCES `egresado` (`id`),
  ADD CONSTRAINT `seguimiento_ibfk_3` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitud` (`id`),
  ADD CONSTRAINT `seguimiento_ibfk_4` FOREIGN KEY (`id_administrativo`) REFERENCES `administrativo` (`id`);
